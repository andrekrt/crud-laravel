    ...
    <div class="card mb-4">
        <div class="card-header space-between-elements">
            ...
            <span class="d-flex justify-content-center">
                ...
                <a href="{{route('perfil-show')}}" class="btn btn-primary btn-sm me-1"> <i class="fa-solid fa-eye"></i> Visualizar </a> 
             </span>
        </div>
        <div class="card-body">
            ...
            <form action="{{route('perfil-update')}}" method="post" class="row g-3">
                @csrf
                @method('PUT')
                <div class="col-12">
