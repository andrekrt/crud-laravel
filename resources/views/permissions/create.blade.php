        ...
        <div class="card-body">
            ...
            <form action="{{route('permission-store')}}" method="post" class="row g-3">
                ...
                <div class="col-12">
                    ...
                    <input type="text" name="title" id="title" placeholder="Nome do Título" value="{{old('title')}}" class="form-control">
                </div>

                <div class="col-12">
                    <label for="name" class="form-label">Nome:</label>
                    <input type="text" name="name" id="name" placeholder="Nome da Permissão" value="{{old('name')}}" class="form-control">
                </div>
